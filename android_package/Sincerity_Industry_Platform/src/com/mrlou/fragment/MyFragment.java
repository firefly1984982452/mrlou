...
public class MyFragment extends Fragment implements HttpListener {
	...
	,bdobject_type="sss", bdobject_id="sss", bdis_avatar="sss", bdmark="sss",bdcut="sss"
	,cur="sss",prams="sss",detail="sss",shareimg="",sharecontent="",shareurl="",sharetitle="",sharecopy="";
	...
	final class DemoJavaScriptInterface {
		...
		public void hidebottom() {
			...
			handle.post(new Runnable() {
				...
				@Override
				public void run() {
					//				((MainFragmentActivity)getActivity()).hidemainbottom();
		...
		public void showbottom(){
			...
			handle.post(new Runnable() {
				...
				@Override
				public void run() {
					//				((MainFragmentActivity)getActivity()).showmainbottom();
