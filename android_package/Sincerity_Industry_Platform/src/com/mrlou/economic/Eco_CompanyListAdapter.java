...
public class Eco_CompanyListAdapter extends BaseAdapter {

	private Context mContext;
	private ArrayList<String> str_name, str_phone, str_year, str_company,
			str_deal, str_url, str_url_flag, str_status;
	private ViewHolder viewHolder;
	DisplayImageOptions options, options2; // DisplayImageOptions是用于设置图片显示的类
			// private ImageLoader imageLoader;

	public Eco_CompanyListAdapter(Context context, ArrayList<String> url,
	...
	public View getView(int position, View view, ViewGroup parent) {
		...
		if (view == null) {
			...
			view = (View) inflate.inflate(R.layout.economic_list_company_agent,
					null);
			viewHolder.tv_name = (TextView) view
					.findViewById(R.id.tv_economic_agent_name);
			viewHolder.iv_phone = (ImageView) view
					.findViewById(R.id.iv_economic_agent_phone);
			viewHolder.lay_company = (LinearLayout) view
					.findViewById(R.id.lay_economic_company_name);
			viewHolder.tv_company = (TextView) view
					.findViewById(R.id.tv_economic_compangy_name);
			viewHolder.tv_year = (TextView) view
					.findViewById(R.id.tv_economic_agent_year);
			viewHolder.tv_deal = (TextView) view
					.findViewById(R.id.tv_economic_deal);
			viewHolder.iv_pic = (ImageView) view
					.findViewById(R.id.iv_economic_company_pic);
			viewHolder.iv_head = (ImageView) view
					.findViewById(R.id.iv_economic_company_head);
			viewHolder.lay_economic_company_head = (LinearLayout) view
					.findViewById(R.id.lay_economic_company_head);
			viewHolder.lay_economic_company_pic = (LinearLayout) view
					.findViewById(R.id.lay_economic_company_pic);
...
//			imageLoader.loadImage(str_url.get(position), 100, 100,
//					viewHolder.iv_pic);

			if (str_status.get(position).equals("1")) {
				viewHolder.tv_year.setText("租赁    " + str_year.get(position)
						+ "成交");
			} else {
				viewHolder.tv_year.setText("出售    " + str_year.get(position)
						+ "成交");
			}
			viewHolder.tv_deal.setText("客户行业:" + str_deal.get(position));
...
//			imageLoader.loadImage(str_url.get(position), 140, 140,
//					viewHolder.iv_head);
			...
			// viewHolder.iv_phone.setOnClickListener(new OnClickListener() {
			//
			// @Override
	...
	public class ViewHolder {
		private LinearLayout lay_company, lay_economic_company_head,
				lay_economic_company_pic;
		private ImageView iv_phone, iv_pic, iv_head;
		private TextView tv_name, tv_company, tv_year, tv_deal;
