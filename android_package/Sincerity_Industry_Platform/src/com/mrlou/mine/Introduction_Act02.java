...
public class Introduction_Act02 extends Activity {
	...
	private String avatars_id, wechat_qr_id, post_card_id, post_card,
			wechat, wechat_qr,add_v,service_type,company_id,office_building,office_building_id;
	...
	private void findView() {
		...
		lay_mine_intro_back.setOnClickListener(new OnClickListener() {
			...
			public void onClick(View v) {
				// TODO Auto-generated method stub
				Intent intent = new Intent(Introduction_Act02.this,
				...
				Introduction_Act02.this.finish();
			}
		});
