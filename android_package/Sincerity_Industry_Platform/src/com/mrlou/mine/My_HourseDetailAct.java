...
public class My_HourseDetailAct extends Activity implements HttpListener {
	...
	private ListView lv;
	private Hourse_DetailAdapter adapter;
	private String id, buildingname;
	private SharedPreferences sharedPreferences;
	private String url,url2,session_id;
	@Override
	protected void onCreate(Bundle savedInstanceState) {
		...
		sharedPreferences = My_HourseDetailAct.this.getSharedPreferences(
	...
	private void findView() {
		// TODO Auto-generated method stub
//		lay_mine_hourse_add=(LinearLayout) findViewById(R.id.lay_mine_hourse_add);
//		lay_mine_hourse_add.setOnClickListener(new OnClickListener() {
//			
//			@Override
//			public void onClick(View v) {
//				// TODO Auto-generated method stub
//				url = "file:///storage/emulated/0/Android/data/com.mrlou.mrlou/files/bulidersir/fangyuan_select_house_type.html";
//				url2 = "file:///storage/emulated/0/Android/data/com.mrlou.mrlou/files/bulidersir/";
//				Intent intent = new Intent(My_HourseDetailAct.this, YlbMessage_Act.class);
...
//		});
		...
		adapter = new Hourse_DetailAdapter(My_HourseDetailAct.this, str_id,
				str_category, str_building_id, str_building_name, str_avatar,
				str_transaction_type, str_unit_no, str_status, str_verified,
				str_image_total, str_rent_price, str_sell_price, str_unique,
				str_time,session_id);
		...
		lv.setOnItemClickListener(new OnItemClickListener() {
			...
			public void onItemClick(AdapterView<?> parent, View view,
				...
				// TODO Auto-generated method stub
				Intent intent = new Intent(My_HourseDetailAct.this,
		...
		new Thread() {
			public void run() {
				try {
					...
					My_HourseDetailAct.this.finish();
				} catch (Exception e) {
	...
	public void select_area(String session_id, String id) {
		Request request = Request.requestmyhourse_detail(session_id, id);
	...
	private Handler newHandler = new Handler() {
		...
		public void handleMessage(Message msg) {
			...
			case 1:
				...
				break;
			case 2:
				Toast.makeText(My_HourseDetailAct.this, "暂无数据", Toast.LENGTH_SHORT).show();
				break;
			case 99:
				Toast.makeText(My_HourseDetailAct.this, "网络异常，请尝试下拉刷新", Toast.LENGTH_SHORT)
						.show();
				break;
			}
		}
