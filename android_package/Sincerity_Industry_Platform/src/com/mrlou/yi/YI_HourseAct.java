...
/**
 * @author jx_chen
 * @date 2016-10-31---上午9:55:40
 * @problem
 */
public class YI_HourseAct extends Activity implements HttpListener {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		setContentView(R.layout.yi_house);
		sharedPreferences = YI_HourseAct.this.getSharedPreferences("user",
				Activity.MODE_PRIVATE);
		session_id = sharedPreferences.getString("session_id", "");
		init();
		select_yi_hourse(session_id, "1", "1");
		refresh();
	}
				...
				.setOnRefreshListener(new OnRefreshListener<ScrollView>() {
					...
					public void onRefresh(
						...
						if (str_avatar.size()<20) {
							...
							Toast.makeText(YI_HourseAct.this, "已经浏览到底部了", Toast.LENGTH_SHORT).show();
						}else if (areacode.equals("1")) {
							select_yi_hourse(session_id, "" + num, "1");
							new GetDataTask().execute();
						}else {
							select_yi_hourse_search(session_id, "" + num, "1",areacode);
							new GetDataTask().execute();
						}
	...
	private void findView() {
		// TODO Auto-generated method stub
		lv_hourse = (ListView) findViewById(R.id.lv_yi_hourse);
		adapter = new Yi_Adapter(YI_HourseAct.this, str_id, str_user_id,
		...
		lv_hourse.setOnItemClickListener(new OnItemClickListener() {
			...
			public void onItemClick(AdapterView<?> parent, View view,
				...
				// TODO Auto-generated method stub
				mrString = YI_HourseAct.this.getExternalFilesDir(null)
						.getPath();
				url = "file://" + mrString + "/bulidersir/ylb_thread.html";
				url2 = "file://" + mrString + "/bulidersir/";
				Intent intent = new Intent(YI_HourseAct.this, Ylb_act.class);
	...
	private Handler newHandler = new Handler() {
		...
		public void handleMessage(Message msg) {
			...
			case 1:
				...
				break;
			case 2:
				Toast.makeText(YI_HourseAct.this, "暂无数据", Toast.LENGTH_SHORT).show();
				break;
			case 3:
				adapter.notifyDataSetChanged();
				break;
			case 99:
				Toast.makeText(YI_HourseAct.this, "网络异常，请重新尝试连接", Toast.LENGTH_SHORT).show();
				break;
			}
		}
	};
	...
	public static void setSelect(ArrayList<String> id,
			...
			ArrayList<String> subject, ArrayList<String> region,ArrayList<String> reply_total,ArrayList<String> like_total) {
		if (str_avatar != null) {
			clear();
		}
