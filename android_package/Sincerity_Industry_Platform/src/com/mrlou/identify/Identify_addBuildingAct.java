...
public class Identify_addBuildingAct extends Activity implements HttpListener {
	...
	private String phone_number, username, email, en_username, cn_username,
			company, avatar, status, type, user_id;
	private String avatars_id, wechat_qr_id, post_card_id, photo_stream,
			post_card, wechat, wechat_qr,type_id,company_id;
	...
	private void findView() {
		...
		lay_addbuilding_complete.setOnClickListener(new OnClickListener() {
			...
			public void onClick(View v) {
				...
				Intent intent;
				intent = new Intent(Identify_addBuildingAct.this,
				...
				Identify_addBuildingAct.this.finish();
			}
		});
		...
		lay_mine_addbuilding_confirm.setOnClickListener(new OnClickListener() {
			...
			public void onClick(View v) {
				...
				if (et_search.getText().toString().equals("")) {
					Toast.makeText(Identify_addBuildingAct.this, "请输入相对应楼盘", Toast.LENGTH_SHORT)
							.show();
				} else {
					if (num_len <= 20) {
						...
						Toast.makeText(Identify_addBuildingAct.this,
		...
		adapter = new Add_BuildAdapter(Identify_addBuildingAct.this, str_content);
	...
	public boolean onKeyDown(int keyCode, KeyEvent event) {
		...
		if (keyCode == KeyEvent.KEYCODE_BACK && event.getRepeatCount() == 0) {
			Intent intent;
			intent = new Intent(Identify_addBuildingAct.this, Identify_ProAct.class);
			intent.putExtra("cn_username", cn_username);
			intent.putExtra("en_username", en_username);
			intent.putExtra("email", email);
	...
	private Handler newHandler = new Handler() {
		...
		public void handleMessage(Message msg) {
			...
			case 1:
				...
				break;
			case 2:
				Toast.makeText(Identify_addBuildingAct.this, "系统无法找到该楼盘，可直接点击确认添加",
						Toast.LENGTH_SHORT).show();
				break;
			case 99:
				Toast.makeText(Identify_addBuildingAct.this, "网络异常，请重新尝试连接", Toast.LENGTH_SHORT)
						.show();
				break;
			}
		}
