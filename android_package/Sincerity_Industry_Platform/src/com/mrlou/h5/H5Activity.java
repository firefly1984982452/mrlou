...
public class H5Activity extends Activity implements HttpListener {
						...
						new OnSheetItemClickListener() {
							...
							public void onClick(int which) {
								if (!Environment
									...
									Toast.makeText(H5Activity.this, "存储空间未就绪！",
	...
	final class DemoJavaScriptInterface {
		...
		public void androidIs(String type, String data) {
			...
			if (type == "1" || "1".equals(type)) {
				...
				startActivity(new Intent(H5Activity.this,Elite_meetingAct.class));
			}
		}
		@JavascriptInterface
		...
		public void openlogin() {
			handle.post(new Runnable() {
				...
				public void run() {
					...
					startActivity(intent);
					H5Activity.this.overridePendingTransition(R.anim.zoom_in,
							R.anim.zoom_out);
				}
			});
		}
		...
		public void logout() {
			handle.post(new Runnable() {
				@Override
				public void run() {
					if (TextUtils.isEmpty(H5Activity.this.getSharedPreferences(
	...
	public void uploadimgrequest(String photo, String object_type,
		...
		Request request = Request.requestImg(photo, object_type, object_id,
				is_avatar, mark);
		new HttpThread(request, H5Activity.this);
	}

	public void loginrequest(String token, String device_id, String sys_agent) {
		SharedPreferences preferences = H5Activity.this.getSharedPreferences(
	...
	private void initpopwindow() {
		View contentView = H5Activity.this.getLayoutInflater().inflate(
	...
	private final class ItemClickListener implements OnItemClickListener {
		...
		public void onItemClick(AdapterView<?> parent, View view, int position,
			...
			case 0:// 微信好友
				...
				mController.postShare(H5Activity.this, SHARE_MEDIA.WEIXIN,
						mShareListener);
			...
			case 1:// 微信朋友圈
				...
				mController.postShare(H5Activity.this,
			...
			case 2:// qq
				...
				mController.postShare(H5Activity.this, SHARE_MEDIA.QQ,
						mShareListener);
			...
			case 3:// qq空间
				...
				mController.postShare(H5Activity.this, SHARE_MEDIA.QZONE,
						mShareListener);
			...
			case 4:// 短信
				...
				mController.postShare(H5Activity.this, SHARE_MEDIA.SMS,
						mShareListener);
				tosharelog(shareidString, SHARE_MEDIA.SMS.toString());
				popupWindow.dismiss();
				break;
			case 5:// 复制
				ClipboardManager cmb = (ClipboardManager) H5Activity.this
						.getSystemService(Context.CLIPBOARD_SERVICE);
				cmb.setText(fenxiangall.trim());
				Toast.makeText(H5Activity.this, "复制成功", Toast.LENGTH_SHORT)
						.show();
				popupWindow.dismiss();
				break;
			case 6:// 新浪
				FenxiangSina(sharetitle, sharecopy, shareurl);
				mController.postShare(H5Activity.this, SHARE_MEDIA.SINA,
						mShareListener);
			...
			case 7:// 邮箱
				FenxiangEmailSms(sharecontent, shareurl);
				mController.postShare(H5Activity.this, SHARE_MEDIA.EMAIL,
						mShareListener);
	...
	private ListAdapter getAdapter() {
		...
		SimpleAdapter simpleAdapter = new SimpleAdapter(H5Activity.this, data,
	...
	private void Fenxiangqq(String title, String content, String url) {
		QQShareContent qqShareContent = new QQShareContent(new UMImage(
				H5Activity.this, shareimg));
		qqShareContent.setTitle(title);
		qqShareContent.setShareContent(content);
		qqShareContent.setTargetUrl(url);
		mController.setShareMedia(qqShareContent);
		UMQQSsoHandler qqSsoHandler = new UMQQSsoHandler(H5Activity.this,
	...
	private void FenxiangqqQz(String title, String content, String url) {
		QZoneShareContent qZoneShareContent = new QZoneShareContent(
				new UMImage(H5Activity.this, shareimg));
		qZoneShareContent.setTitle(title);
		qZoneShareContent.setShareContent(content);
		qZoneShareContent.setTargetUrl(url);
		mController.setShareMedia(qZoneShareContent);
		QZoneSsoHandler qZoneSsoHandler = new QZoneSsoHandler(H5Activity.this,
				"1104815437", "9sS47vI7nCTIhXvR");
	...
	private void Fenxiangweixin(String title, String content, String url) {
		...
		UMWXHandler wxHandler = new UMWXHandler(H5Activity.this, appID,
				appSecret);
	...
	private void Fengwxcicle(String title, String content, String url) {
		String appID = "wx5f8d6e9fa8ae4fa7";
		String appSecret = "55b897d2af6dd94bdf1ab29b5c02725c";
		UMWXHandler wxCircleHandler = new UMWXHandler(H5Activity.this, appID,
				appSecret);
	...
	Handler requestHandler = new Handler() {
		...
		public void handleMessage(android.os.Message msg) {
			switch (msg.what) {
			case 0:
				Toast.makeText(H5Activity.this, errorString, Toast.LENGTH_SHORT)
						.show();
				break;
			case 1:
				Toast.makeText(H5Activity.this, errorString, Toast.LENGTH_SHORT)
		...
		if (reqID == Request.REQUEST_LOGINBYTOKEN) {
			try {
				...
				if (errorid.equals("0")) {
					...
					userSharedPreferences = H5Activity.this
	...
	public void uploadimgresult(int requestCode, int resultCode, Intent data) {
		...
		if (requestCode == IMAGE) {// 相册
			if (data == null) {
				Toast.makeText(H5Activity.this, "从相册获取返回错误", Toast.LENGTH_SHORT)
						.show();
				return;
			}
			if (bdcut.equals("2")) {
				...
				try {
					bitmap = MediaStore.Images.Media.getBitmap(
							H5Activity.this.getContentResolver(),
							data.getData());
		...
		if (requestCode == RESULT) {
			if (data == null) {
				Toast.makeText(H5Activity.this, "裁剪已取消", Toast.LENGTH_SHORT)
						.show();
				return;
			}
