...
public class AddServices_HistoryAct extends Activity implements HttpListener {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		setContentView(R.layout.addservices_history);
		sharedPreferences = AddServices_HistoryAct.this.getSharedPreferences(
	...
	private void findView() {
		...
		lay_mine_history_back = (LinearLayout) findViewById(R.id.lay_addservices_history_back);
		...
		lv_history = (ListView) findViewById(R.id.lv_addservices_history);
		adapter = new History_Adapter(AddServices_HistoryAct.this, str_id,str_name,
		...
		lv_history.setOnItemClickListener(new OnItemClickListener() {
			...
			public void onItemClick(AdapterView<?> parent, View view,
				...
				// TODO Auto-generated method stub
				if (flag.equals("1")) {
					Intent intent = new Intent(AddServices_HistoryAct.this, AddServices_EditInfoAct.class);
					intent.putExtra("id", str_id.get(position));
					intent.putExtra("add_v", add_v);
					startActivity(intent);
					AddServices_HistoryAct.this.finish();
				}
			}
		});

		bt_check = (Button) findViewById(R.id.bt_addservices_history1);
		bt_uncheck = (Button) findViewById(R.id.bt_addservices_history2);
		...
		lay_min_history_add = (LinearLayout) findViewById(R.id.lay_addservices_history_add);
		lay_min_history_add.setOnClickListener(new OnClickListener() {

			@Override
			public void onClick(View v) {
				// TODO Auto-generated method stub
				Intent intent = new Intent(AddServices_HistoryAct.this,
						AddServices_AddInfoAct.class);
				intent.putExtra("add_v", add_v);
				startActivity(intent);
				AddServices_HistoryAct.this.finish();
			}
	...
	private Handler newHandler = new Handler() {
		...
		public void handleMessage(Message msg) {
			...
			case 1:
				...
				break;
			case 2:
				Toast.makeText(AddServices_HistoryAct.this, "暂无数据", Toast.LENGTH_SHORT).show();
				break;
			case 99:
				Toast.makeText(AddServices_HistoryAct.this, "网络异常，请重新尝试连接", Toast.LENGTH_SHORT)
						.show();
				break;
			}
		}
	...
	public void select_cjinfomain(String session_id) {
		Request request = Request.request_addservice_cjinfomain(session_id);
