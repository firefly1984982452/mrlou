...
public class Message_ShortHourseAct extends Activity implements HttpListener {
	...
	private TextView tv_shorthourse_name;
	@Override
	protected void onCreate(Bundle savedInstanceState) {
		// TODO Auto-generated method stub
		super.onCreate(savedInstanceState);
		setContentView(R.layout.message_singlebuilder);
		sharedPreferences = Message_ShortHourseAct.this.getSharedPreferences(
	...
	public void select_standoffice() {
		Request request = Request.requestshorthourse();
	...
	private void findView() {
		// TODO Auto-generated method stub
		tv_shorthourse_name=(TextView) findViewById(R.id.tv_shorthourse_name);
		tv_shorthourse_name.setText("联合办公室出租");
		...
		adapter = new Message_SingleBuilderAdapter(
				Message_ShortHourseAct.this, str_id, str_category,
		...
		lv_message_singlebuilder.setOnItemClickListener(new OnItemClickListener() {
			...
			public void onItemClick(AdapterView<?> parent, View view,
				...
				// TODO Auto-generated method stub
				mrString = Message_ShortHourseAct.this.getExternalFilesDir(null).getPath();
				url = "file://"+mrString+"/bulidersir/lxs_index.html";
				url2 = "file://"+mrString+"/bulidersir/";
				Intent intent = new Intent(
						Message_ShortHourseAct.this,
						RoomInfo_Act.class);
		...
		new Thread() {
			public void run() {
				try {
					...
					Message_ShortHourseAct.this.finish();
				} catch (Exception e) {
