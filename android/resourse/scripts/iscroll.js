...
// INSERT POINT: OPTIONS 
		...
		preventDefault: true,
		preventDefaultException: { tagName: /^(INPUT|TEXTAREA|BUTTON|SELECT|LABEL|SPAN|A})$/ },
...
/* REPLACE START: _move */
        ...
        /* REPLACE END: _move */
		//添加一个滚动过程中的事件扩展,目前这个版本中只对scrollStart、scrollEnd、refresh、三个事件进行扩展,
		//若将来新版本有加此事件,可相应替换,（名字是自己随便写的，只要和使用时绑定的事件名字一样就行）
