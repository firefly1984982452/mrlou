...
(function ($) {      
	...
	function resetIndex(){
        ...
        function extendOptions(){
            $("#datePage").show(); 
            $("#dateshadow").show();
            $("#dateconfirm")[0].ontouchstart = function(e){
                e.preventDefault()
            }
            $("#datecancle")[0].ontouchstart = function(e){
                e.preventDefault()
            }
        }
        ...
        function init_iScrll() { 
            ...
            var strM = $("#monthwrapper ul li:eq("+indexM+")").html().substr(0,$("#monthwrapper ul li:eq("+indexM+")").html().length-1)
              ...
              dayScroll = window.dayScroll = new iScroll("daywrapper",{snap:"li",checkDOMChanges:true,
                  onScrollEnd:function () {
